...
@Composable
fun Inventario(navController: NavController,viewmodelInventario: ViewModel_Inventario) {
...
@Composable
fun BookListScreen() {
    var codigo_barra: String? by remember { mutableStateOf(0) }
                ...
                Row(
                    ...
                    IconButton(
                        onClick = {
                            ...
                            options.setDesiredBarcodeFormats(ScanOptions.ALL_CODE_TYPES) // QR + códigos de barras
                        ...
                        Icon(
                            ...
                            contentDescription = "Favorite icon" // Important for accessibility
                        )
                    }
...
fun BookCard(book: Dt_Book) {
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Text(text = "Categoria: ${book.IDCATEGORIA}")
